...
class MovieIndex extends Component
{
    ...
    public function generateMovie()
    {
        ...
        $url = 'https://api.themoviedb.org/3/movie/' . $this->tmdbId . '?api_key=9510154dda5827dc6ce167f4d0027379&language=en-US';
    ...
    public function addTrailer()
    {
        ...
        $this->dispatchBrowserEvent('banner-message', ['style' => 'success', 'message' => 'Trailer added successfully']);
        $this->reset();
    }
