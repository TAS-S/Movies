<section class="container mx-auto p-6 font-mono">
    ...
    <x-jet-dialog-modal wire:model="showMovieModal">
        ...
        <x-slot name="footer">
            <x-m-button wire:click="closeMovieModal" class="mr-2 bg-red-500 hover:bg-red-700">Cancel</x-m-button>
                        ...
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="flex flex-col">
                                    ...
                                    <input wire:model="trailerName" type="text" autocomplete="given-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    @error('trailerName')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
