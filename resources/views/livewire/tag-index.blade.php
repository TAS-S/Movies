                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm border">
                                <x-m-button wire:click="showEditModal({{ $tag->id }})"
                                    class="mr-2 bg-green-500 hover:bg-green-700">Edit</x-m-button>
                                <x-m-button wire:click="deleteTag({{ $tag->id }})" class="bg-red-500 hover:bg-red-700">
                                    Delete</x-m-button>
                            </td>
                        </tr>
                        @empty
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="first-name" class="block text-sm font-medium text-gray-700">Tag
                                                name</label>
                                            <input wire:model="tagName" type="text" name="tagName"
